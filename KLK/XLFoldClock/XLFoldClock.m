...
- (void)buildUI {
    ...
    _mlabel.text = @":";
    _mlabel.font = [UIFont systemFontOfSize:100];
    _mlabel.textAlignment = NSTextAlignmentCenter;
    _mlabel.textColor = [UIColor colorWithRed:186/255.0f green:183/255.0f blue:186/255.0f alpha:1];
    ...
    _m1label = [[UILabel alloc]init];
    _m1label.text = @":";
    _m1label.font = [UIFont systemFontOfSize:100];
    _m1label.textAlignment = NSTextAlignmentCenter;
    _m1label.textColor = [UIColor colorWithRed:186/255.0f green:183/255.0f blue:186/255.0f alpha:1];
    [self addSubview:_m1label];
...
- (void)layoutSubviews {
    ...
    _mlabel.frame = CGRectMake(CGRectGetMaxX(_hourItem.frame), itemY - 10 , margin, itemW);
    _minuteItem.frame = CGRectMake(CGRectGetMaxX(_hourItem.frame) + margin, itemY, itemW, itemW);
    _m1label.frame = CGRectMake(CGRectGetMaxX(_minuteItem.frame), itemY - 10 , margin, itemW);
